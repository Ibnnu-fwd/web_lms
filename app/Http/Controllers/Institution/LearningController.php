...
class LearningController extends Controller
{
    ...
    public function detail($id, $page)
    {
        ...
        return view('institution.learning.index', [
            'course' => $course,
    ...
    */
    public function courseChapterComplete($id)
    {
        ...
        if ($chapter->quiz) {
            return redirect()->route('institution.course.quiz', $chapter->quiz->id);
        }

        // cek jika chapter adalah chapter terakhir dari course
        if ($chapter->is_last) {
            return redirect()->route('institution.dashboard')->with('finish', 'Course telah selesai.');
        }

        // jika chapter selanjutnya bukan quiz, maka arahkan ke chapter selanjutnya
        return redirect()->route('institution.course.detail', [$chapter->course_id, $chapter->next_chapter_id]);
    }
    ...
    public function quiz($id)
    {
        ...
        return view('institution.learning.quiz', [
            'course' => $course,
            'quiz' => $quiz,
        ]);
    }
