        ...
        <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:px-16">
          <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            <div class="text-white xl:col-span-1">
              <a href="/" class="text-lg font-bold tracking-tighter text-black transition duration-500 ease-in-out transform tracking-relaxed lg:pr-8">
                <img class="h-8" src="{{ asset('images/logo.png') }}" alt="logo" />
              </a>
            </div>
            <div class="grid grid-cols-2 gap-8 mt-12 xl:mt-0 xl:col-span-2">
              <div class="md:grid md:grid-cols-2 md:gap-8">
                ...
                <div class="mt-12 md:mt-0">
                  ...
                  <ul role="list" class="mt-4 space-y-2">
                    <li>
                      <a href="https://www.wickedbackgrounds.com/" class="text-sm text-gray-500 hover:text-red-600">
                        Wicked Backgrounds
                      </a>
                    </li>

                    <li>
                      <a href="https://www.colorsandfonts.com/" class="text-sm text-gray-500 hover:text-red-600">
                        Colors &amp; Fonts
                      </a>
                    </li>
                    <li>
                      <a href="https://www.serendipitytheme.com/" class="text-sm text-gray-500 hover:text-red-600">
                        Serendipity</a>
                    </li>
                    <li>
                      <a href="https://www.brutalist.one/" class="text-sm text-gray-500 hover:text-red-600">
                        Brutalist One</a>
                    </li>
                  </ul>
                </div>
