...
<li>
    <a href="{{ $route }}"
        {{ $attributes->merge([
            'class' =>
                'inline-flex items-center w-full px-4 py-2 mt-1 text-md transition duration-200 ease-in-out transform rounded-lg focus:shadow-outline hover:bg-gray-100 hover:scale-95 ' .
