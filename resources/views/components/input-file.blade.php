...
<div class="mb-4">
    ...
    <div class="image-container-{{ $id }}">
        <div class="flex items-center justify-center w-full">
            <label for="{{ $id }}"
                class="flex flex-col items-center justify-center w-full h-28 border-0 ring-1 ring-inset ring-gray-300 rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-10">
